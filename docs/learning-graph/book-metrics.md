...
| 6 | Chapter References | 15 / 15 | Recommended | Chapters with references.md (75 references total) |
| 7 | Glossary Terms | 297 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 71 | Recommended | Questions in faq.md |
| 9 | Words | 142,893 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 138 | 138 | H4 headers starting with '#### Diagram:' |
| Equations | 85 | 82 | LaTeX expressions (inline and display) |
| Total Words | 142,893 | 115,955 | Words in markdown files |
| Links | 202 | 105 | Hyperlinks in markdown format |
| Equivalent Pages | 610 | 502 | Estimated pages (250 words/page + visuals) |
