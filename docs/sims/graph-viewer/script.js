...
function initializeNetwork() {
    ...
    // Re-enable physics while dragging a node
    ...
    // Disable physics when drag ends
...
function buildLegend() {
    ...
    // Define the order of categories to match taxonomy-names.json
    const categoryOrder = [
        'NUMSYS', 'BOOL', 'GATES', 'COMB', 'BLOCKS',
        'SEQ', 'FLIPFLOP', 'FSM', 'REG', 'HDL', 'VERIFY'
    ];

    // Sort groups by the defined order, putting unknown groups at the end
